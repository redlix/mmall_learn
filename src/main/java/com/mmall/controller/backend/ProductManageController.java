...
//        if (com.alipay.api.internal.util.StringUtils.isEmpty(loginToken)) {
...
//        }
    ...
    @ResponseBody
    public ServerResponse searchList(HttpServletRequest httpServletRequest, String productName, Integer productId, @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum, @RequestParam(value = "pageSize", defaultValue = "10") Integer pageSize) {
//        String loginToken = CookieUtil.readLoginToken(httpServletRequest);
//        if (com.alipay.api.internal.util.StringUtils.isEmpty(loginToken)) {
//            return ServerResponse.createByErrorMsg("当前用户未登录，无法获取有效信息");
//        }
...
//            resultMap.put("msg", "当前用户未登录，无法获取有效信息");
//            return resultMap;
//        }
//        String userJsonStr = RedisShardedPoolUtil.get(loginToken);
//        User user = JsonUtil.stringToObj(userJsonStr, User.class);
